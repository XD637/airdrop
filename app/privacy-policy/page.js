...
export default function PrivacyPolicyPage() {
  return (
    <div className="flex items-center justify-center min-h-screen bgbg-gray-100 text-black ">
      <div className="p-6 bg-gray-100 text-black rounded-lg shadow-lg w-full sm:w-3/4 md:w-2/3 lg:w-full">
        ...
        <p>You have the right to access, update, or delete your data. For requests, contact us at <a href="mailto:contact@xennium.org" className="text-purple-700">contact@xennium.org</a>.</p>
        ...
        <p>If you have any questions, feel free to contact us at <a href="mailto:contact@xennium.org" className="text-purple-700">contact@xennium.org</a>.</p>
